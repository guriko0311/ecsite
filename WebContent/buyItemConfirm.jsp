...
<body>
<!-- 		下の画面が表示されて戻るをクリックするとHomeActionに飛ぶ(飛ぶとHomeActionが実行され、 -->
<!-- 		buyItem.jspの画面が表示される) -->
<!-- 		完了をクリックするとBuyItemConfirmActionに飛ぶ -->
<!-- 		前画面に戻る場合はのこちらをクリックするとGoHomeActionに飛ぶ -->
<!-- 		マイページはのこちらをクリックするとMyPageActionに飛ぶ -->
<!-- 							↓↓ -->
		<div id = "header">
				<div id = "pr">
				</div>
